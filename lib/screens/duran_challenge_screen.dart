          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'مثلاً: ختم سورة البقرة',
            ...
            Row(
              children: [
                Expanded(
                  child: _buildPageSelector('صفحة البداية', _startPage, (v) => setState(() => _startPage = v.clamp(1, 604))),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _buildPageSelector('صفحة النهاية', _endPage, (v) => setState(() => _endPage = v.clamp(1, 604))),
                ),
              ],
            ),
            const SizedBox(height: 20),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('تم بدء تحدي "${challenge.title}" بنجاح!')),
                );
              },
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text('$value', textAlign: TextAlign.center, style: GoogleFonts.ibmPlexSansArabic(fontSize: 18, fontWeight: FontWeight.w900)),
              ),
              IconButton(
